<template>
  <div class="app">
    ...
    <!-- Reels Section -->
    <section id="reels">
      <h1 class="headerh1">SOUND DESIGN DEMOS WITH VIDEO</h1>
      <div class="reelsframes">
    ...
    <section id="scoremusic">
      <h1 class="headerh2">MUSIC SCORES</h1>
      <div class="examplemusic">
        <div class="examplediv" v-for="track in musicTracks" :key="track.src">
          <audio controls>
    ...
    <section id="sound-effects">
      <h1 class="headerh1">SOUND EFFECTS</h1>
      <div class="sfxdiv">
        <div class="audiocontrols3" v-for="sfx in soundEffects" :key="sfx.src">
          <audio controls>
